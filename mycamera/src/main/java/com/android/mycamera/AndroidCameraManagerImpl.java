...
import static com.android.mycamera.util.CameraUtil.Assert;
                ...
                switch (msg.what) {
                    ...
                    case START_PREVIEW_ASYNC:
                        try {
                            ...
                            Toast.makeText(CameraActivity.mCameraActivity, "[Camera] There is a malfunction.", Toast.LENGTH_SHORT).show();
