...
public class MediaDetails implements Iterable<Entry<Integer, Object>> {
    ...
    public static String formatDuration(final Context context, long seconds) {
        ...
        if (h == 0) {
            durationValue = String.format(Locale.ENGLISH,context.getString(R.string.details_ms), m, s);
        } else {
            durationValue = String.format(Locale.ENGLISH,context.getString(R.string.details_hms), h, m, s);
        }
