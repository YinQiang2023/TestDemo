...
import com.android.mycamera.app.AppManagerFactory;
import com.android.mycamera.app.PanoramaStitchingManager;
import com.android.mycamera.crop.CropActivity;
import com.android.mycamera.data.CameraDataAdapter;
import com.android.mycamera.data.CameraPreviewData;
import com.android.mycamera.data.FixedFirstDataAdapter;
import com.android.mycamera.data.FixedLastDataAdapter;
import com.android.mycamera.data.InProgressDataWrapper;
import com.android.mycamera.data.LocalData;
import com.android.mycamera.data.LocalDataAdapter;
import com.android.mycamera.data.LocalMediaObserver;
import com.android.mycamera.data.MediaDetails;
import com.android.mycamera.data.SimpleViewData;
import com.android.mycamera.tinyplanet.TinyPlanetFragment;
import com.android.mycamera.ui.ModuleSwitcher;
import com.android.mycamera.ui.DetailsDialog;
...
import com.android.mycamera.util.GcamHelper;
import com.android.mycamera.util.PhotoSphereHelper;
import com.android.mycamera.util.PhotoSphereHelper.PanoramaViewHelper;

import java.io.IOException;

import static com.android.mycamera.CameraManager.CameraOpenErrorCallback;

public class CameraActivity extends Activity implements ModuleSwitcher.ModuleSwitchListener, ActionBar.OnMenuVisibilityListener {
    ...
    public LocalDataAdapter getLocalDataAdapter() {
        return mDataAdapter;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == android.R.id.home) {// ActionBar's Up/Home button was clicked
            try {
    ...
    public void onCreate(Bundle state) {
        ...
        findViewById(R.id.paizhao).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Toast.makeText(CameraActivity.this,"拍照",Toast.LENGTH_SHORT).show();
                if (mCurrentModule instanceof PhotoModule) {
                    ((PhotoModule) mCurrentModule).onShutterButtonClick();
                } else {
                    try {
    ...
    public void onDestroy() {
        ...
        broadcastCloseDevicePhoto(CameraActivity.this);
    ...
    private void initBroadcast() {
        ...
        filter.addAction(TAG_SEND_PHOTO_ACTION);
     ...
     * 摇一摇拍照
     */
    public static void broadcastCloseDevicePhoto(Context context) {
        final Intent intent = new Intent();
        intent.setAction(TAG_CLOSE_PHOTO_ACTION);
