...
import com.android.mycamera.CameraPreference.OnPreferenceChangedListener;
import com.android.mycamera.FocusOverlayManager.FocusUI;
...
import com.android.mycamera.ui.PieRenderer.PieListener;
...
public class PhotoUI implements PieListener,
    ...
    public void hideUI() {
        ...
        if (mSwitcher != null) mSwitcher.closePopup();
    }
