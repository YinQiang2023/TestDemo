...
import com.android.mycamera.app.OrientationManager;
import com.android.mycamera.exif.ExifInterface;
import com.android.mycamera.ui.RotateTextToast;
import com.android.mycamera.util.AccessibilityUtils;
...
public class VideoModule implements CameraModule,
    ...
    private String createName(long dateTaken) {
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                mActivity.getString(R.string.video_file_name_format), Locale.ENGLISH);
    ...
    private void generateVideoFilename(int outputFileFormat) {
        ...
        mCurrentVideoValues.put(Video.Media.RESOLUTION, mProfile.videoFrameWidth + "x" + mProfile.videoFrameHeight);
        Location loc = mLocationManager.getCurrentLocation();
        if (loc != null) {
