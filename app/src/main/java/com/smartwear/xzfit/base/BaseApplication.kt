package com.smartwear.xzfit.base
...
import com.smartwear.xzfit.utils.manager.StravaManager
...
class BaseApplication : Application(), OnMapsSdkInitializedCallback {
    companion object {
        ...
        fun initDataReduction() {
            com.smartwear.xzfit.utils.AppUtils.tryBlock {
    ...
    override fun onCreate() {
        ...
        if (packageName == name) {
            ...
            //debug log
            LogUtils.getConfig().setLogSwitch(com.smartwear.xzfit.utils.AppUtils.isBetaApp()).setBorderSwitch(false)
    ...
    fun initControlBleTools(context: Context) {
        //设备日志 仅测试版本写日志
        val isWriteLog = com.smartwear.xzfit.utils.AppUtils.isBetaApp()
        ...
        if (ControlBleTools.getInstance().isInit) {
            com.smartwear.xzfit.utils.LogUtils.d("SDK", "initControlBleTools return : isInit == true")
            return
        }
    ...
    class NotificationServiceConnection : ServiceConnection {
        override fun onServiceConnected(name: ComponentName?, service: IBinder?) {
            com.smartwear.xzfit.utils.LogUtils.d("MyNotificationsService", "onServiceConnected:$name")
        }

        override fun onServiceDisconnected(name: ComponentName?) {
            com.smartwear.xzfit.utils.LogUtils.d("MyNotificationsService", "onServiceDisconnected:$name")
        }
    }
    //endregion
    ...
    private fun initBetaFireWareUpPath() {
        if (com.smartwear.xzfit.utils.AppUtils.isBetaApp()) {
    ...
    private fun initNetWorkListener() {
        ...
        NetworkUtils.registerNetworkStatusChangedListener(object : NetworkUtils.OnNetworkStatusChangedListener {
            override fun onDisconnected() {
                ...
                com.smartwear.xzfit.utils.LogUtils.e("NetWork", "网络断开连接", true)
            ...
            override fun onConnected(networkType: NetworkUtils.NetworkType?) {
                ...
                com.smartwear.xzfit.utils.LogUtils.e("NetWork", "网络连接上", true)
                //刷新设备语言列表
            ...
            override fun onActivityDestroyed(activity: Activity) {
                ...
                ThreadUtils.runOnUiThreadDelayed({
                    ...
                    if (ActivityUtils.getActivityList().size == 0) {
                        com.smartwear.xzfit.utils.LogUtils.e("sdk release", "live Activity size == 0")
                        //清除sdk内部设备信息
