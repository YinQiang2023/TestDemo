...
import com.smartwear.xzfit.base.BaseApplication.Companion.mContext
...
import com.smartwear.xzfit.utils.CommonAttributes
...
//        sslSocketFactory?.let { trustManager?.let { it1 -> builder.sslSocketFactory(it, it1) } }
    ...
    val service by lazy {
        getService(ErrorLogService::class.java, AppUtils.getMetaDataByKey("com.smartwear.xzfit.serverUrl"))
    }
