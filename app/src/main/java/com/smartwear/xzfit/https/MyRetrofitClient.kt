...
object MyRetrofitClient : BaseRetrofitClient() {
    ...
    //国内
    val serverUrlZhService by lazy { getService(ApiService::class.java, AppUtils.getMetaDataByKey("com.smartwear.xzfit.serverUrl")) }

    //国外
    val serverUrlEnService by lazy { getService(ApiService::class.java, AppUtils.getMetaDataByKey("com.smartwear.xzfit.foreignServerUrl")) }
