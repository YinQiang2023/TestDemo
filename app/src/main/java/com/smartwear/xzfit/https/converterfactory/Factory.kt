...
package com.smartwear.xzfit.https.converterfactory
...
internal class Factory(
    ...
    override fun responseBodyConverter(
        ...
        return KtxResponseConverter(loader, serializer)
    }
    ...
    override fun requestBodyConverter(
        ...
        return KtxRequestConverter(contentType, saver, serializer)
    }
}
