...
object TrackingRetrofitClient {
    //国内
    private val mBaseURL: String by lazy { AppUtils.getMetaDataByKey("com.smartwear.xzfit.trackingServerUrl")!! }

    //国外
    private val mBaseEnURL: String by lazy { AppUtils.getMetaDataByKey("com.smartwear.xzfit.trackingForeignServerUrl")!! }
