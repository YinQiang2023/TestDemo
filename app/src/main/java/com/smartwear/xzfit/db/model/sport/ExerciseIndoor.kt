package com.smartwear.xzfit.db.model.sport
 ...
 * 室内、自由运动，不带GPS
 */
class ExerciseIndoor : LitePalSupport(), Cloneable {
    //原始数据的id
