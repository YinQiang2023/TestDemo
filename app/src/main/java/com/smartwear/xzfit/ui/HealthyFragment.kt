...
import com.smartwear.xzfit.databinding.FragmentHealthyBinding
import com.smartwear.xzfit.databinding.ItemHealthyFragmentBinding
...
import com.smartwear.xzfit.ui.healthy.EditCardActivity
import com.smartwear.xzfit.ui.healthy.history.*
import com.smartwear.xzfit.ui.healthy.history.womenhealth.WomenHealthActivity
import com.smartwear.xzfit.ui.livedata.RefreshHealthyFragment
import com.smartwear.xzfit.ui.sport.SportRecordActivity
...
import com.smartwear.xzfit.ui.healthy.history.StressActivity
import com.smartwear.xzfit.ui.healthy.bean.SyncDailyInfoBean
import com.smartwear.xzfit.ui.healthy.ecg.EcgActivity
import com.smartwear.xzfit.ui.healthy.history.womenhealth.WomenPeriodSettingActivity
import com.smartwear.xzfit.ui.livedata.RefreshBatteryState
import com.smartwear.xzfit.ui.livedata.RefreshHealthyMainData
import com.smartwear.xzfit.ui.livedata.bean.BatteryBean
...
//        binding.ivEditCard.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG) //下划线
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            if (!PermissionUtils.isGranted(*com.smartwear.xzfit.utils.PermissionUtils.PERMISSION_BLE12)) {
                binding.ivBluetoothState.visibility = View.GONE
            }
        }
        //蓝牙未开启
                    ...
                    getString(R.string.healthy_sports_list_sport_record) -> {
                        if (!isNoData(v.healthyItemBottom, t.context)) {
                            ...
                            v.healthyItemBottom.text = SpannableStringTool.get()
                                .append(TimeUtils.millis2String(t.bottomText.toLong(), com.smartwear.xzfit.utils.TimeUtils.getSafeDateFormat("MM/dd")))
                                .setFontSize(12f)
                                .setForegroundColor(ContextCompat.getColor(requireContext(),R.color.color_878787))
                                .append("   ")
                                .append(TimeUtils.millis2String(t.bottomText.toLong(), com.smartwear.xzfit.utils.TimeUtils.getSafeDateFormat("HH:mm")))
                                .setFontSize(12f)
                                .setForegroundColor(ContextCompat.getColor(requireContext(),R.color.color_878787))
                                .create()
