...
import com.smartwear.xzfit.databinding.FragmentSportBinding
...
import com.smartwear.xzfit.ui.sport.SportCountDownActivity
...
class SportFragment : BaseFragment<FragmentSportBinding, SportModel>(
    ...
    override fun onDestroyView() {
        ...
        AppUtils.tryBlock {
            ...
            /*java.lang.RuntimeException: Unable to destroy activity {com.smartwear.xzfit/com.smartwear.xzfit.ui.HomeActivity}: java.lang.NullPointerException: Attempt to invoke interface method 'boolean com.google.maps.api.android.lib6.impl.bq.W()' on a null object reference
            if (mMapFragment != null && mGoogleMap != null) {
...
//                    viewmodel.getOdometer(mSportType)
    ...
    override fun onVisible() {
        ...
        if (!isInitMap && PermissionUtils.isGranted(*com.smartwear.xzfit.utils.PermissionUtils.PERMISSION_GROUP_LOCATION)) {
            if (!AppUtils.isEnableGoogleMap()) {
                initAMap()
            } else {
                initGoogleMap()
    ...
    fun showPermissionExplainDialog() {
        DialogUtils.showDialogTwoBtn(
            ...
            object : DialogUtils.DialogClickListener {
                override fun OnOK() {
                    LogUtils.d(com.smartwear.xzfit.utils.PermissionUtils.TAG, "申请权限")
                    requestPermissions()
                }
    ...
    fun requestPermissions() {
        ...
        com.smartwear.xzfit.utils.PermissionUtils.requestPermissions(
            ...
            com.smartwear.xzfit.utils.PermissionUtils.PERMISSION_GROUP_LOCATION
        ) {
    ...
    fun checkQLocationPermission(): Boolean {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            if (!PermissionUtils.isGranted(*com.smartwear.xzfit.utils.PermissionUtils.PERMISSION_10_LOCATION)) {
                DialogUtils.dialogShowContentAndTwoBtn(requireActivity(), getString(R.string.background_location_tips),
                    getString(R.string.dialog_cancel_btn), getString(R.string.dialog_confirm_btn), object : DialogUtils.DialogClickListener {
                        override fun OnOK() {
                            PermissionUtils.permission(*com.smartwear.xzfit.utils.PermissionUtils.PERMISSION_10_LOCATION)
