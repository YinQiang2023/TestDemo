...
import com.smartwear.xzfit.databinding.ActivityDebugLogDecodingBinding
...
import com.smartwear.xzfit.utils.AESUtils
import com.smartwear.xzfit.utils.AppUtils
import com.smartwear.xzfit.utils.SaveLog
            ...
            return@withContext withTimeoutOrNull(300 * 1000) {
                suspendCancellableCoroutine {
                    try {
                        ...
                        for (log in cs) {
                            val newLog = StringBuffer(AESUtils.decrypt(log, com.smartwear.xzfit.utils.JsonUtils.serviceKey)).append("\n")
