package com.smartwear.xzfit.ui.guide.item
...
import com.smartwear.xzfit.databinding.FragmentSelectNotificationBinding
...
import com.smartwear.xzfit.ui.device.setting.notify.NotifyOtherSetActivity
...
import com.smartwear.xzfit.viewmodel.MsgNotifyModel
...
//                v.line.visibility = if (t.isShowLine) View.VISIBLE else View.GONE
    ...
    private fun requestPermissions() {
        com.smartwear.xzfit.utils.PermissionUtils.requestPermissions(
            ...
            com.smartwear.xzfit.utils.PermissionUtils.PERMISSIONS_MAIL_AND_PHONE_LIST
        ) {
            if (MyNotificationsService.checkNotificationIsEnable(requireActivity())
                && MyNotificationsService.checkNotificationPolicyAccessGranted(requireActivity())
            ) {
