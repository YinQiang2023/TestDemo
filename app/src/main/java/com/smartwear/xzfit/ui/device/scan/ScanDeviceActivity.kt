...
import com.smartwear.xzfit.databinding.ScanDeviceActivityBinding
...
import com.smartwear.xzfit.ui.adapter.ScanDeviceAdapter
        ...
        when (v?.id) {
            ...
            binding.layoutTitle.layoutRight.id -> {
                ...
                com.smartwear.xzfit.utils.PermissionUtils.checkRequestPermissions(
                    ...
                    com.smartwear.xzfit.utils.PermissionUtils.PERMISSION_GROUP_CAMERA
                ) {
