...
import com.smartwear.xzfit.databinding.ActivityAddEventBinding
import com.smartwear.xzfit.dialog.DialogUtils
import com.smartwear.xzfit.view.wheelview.DatePicker
...
import com.smartwear.xzfit.view.wheelview.widget.DateWheelLayout
...
class AddEventActivity : BaseActivity<ActivityAddEventBinding, DeviceModel>(
    ...
    override fun initView() {
        ...
        binding.tvDate.text = TimeUtils.getNowString(com.smartwear.xzfit.utils.TimeUtils.getSafeDateFormat("yyyy-MM-dd"))
        ...
        binding.tvTime.text = TimeUtils.date2String(Date(), com.smartwear.xzfit.utils.TimeUtils.getSafeDateFormat(com.smartwear.xzfit.utils.TimeUtils.DATEFORMAT_HOUR_MIN))
...
//            }
    ...
    private fun createTimeDialog(inHour: Int, inMinute: Int) {
        ...
        AppUtils.tryBlock {
            isTody = TimeUtils.isToday(dateString, com.smartwear.xzfit.utils.TimeUtils.getSafeDateFormat("yyyy-MM-dd"))
        }
    ...
    private fun returnEventInfo(isIgnoreTime: Boolean = false) {
        ...
        val span = TimeUtils.getTimeSpan(
            TimeUtils.string2Date("$date $time", com.smartwear.xzfit.utils.TimeUtils.getSafeDateFormat(com.smartwear.xzfit.utils.TimeUtils.DATEFORMAT_COM_YYMMDD_HHMM)),
