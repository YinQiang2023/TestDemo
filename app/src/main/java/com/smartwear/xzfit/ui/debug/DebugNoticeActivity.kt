...
import com.smartwear.xzfit.databinding.ActivityDebugNoticeBinding
import com.smartwear.xzfit.ui.debug.bean.NoticeSpinnerItem
        ...
        when (v?.id) {
            ...
            binding.btnStart1.id -> {
                ...
                if (binding.btnStart1.isSelected) {
                    ...
                    binding.btnStart1.setBackgroundColor(getColor(com.smartwear.xzfit.R.color.teal_200))
                ...
                if (binding.btnStart1.isSelected) {
                    ...
                    binding.btnLast.setBackgroundColor(getColor(com.smartwear.xzfit.R.color.teal_200))
                    binding.btnNext.setBackgroundColor(getColor(com.smartwear.xzfit.R.color.teal_200))
                }
