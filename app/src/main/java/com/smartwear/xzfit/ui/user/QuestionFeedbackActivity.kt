...
import com.smartwear.xzfit.databinding.*
import com.smartwear.xzfit.dialog.DialogUtils
import com.smartwear.xzfit.https.HttpCommonAttributes
import com.smartwear.xzfit.ui.adapter.FeedbackImgItem
import com.smartwear.xzfit.ui.adapter.FeedbackScreenshotsAdapter
...
import com.smartwear.xzfit.utils.RegexUtils
...
import com.smartwear.xzfit.view.wheelview.widget.FeedbackDatePicker
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_SELECT_PICTURE_FOR_UPLOAD) {
                try {
                    ...
                    e.printStackTrace()
                    com.smartwear.xzfit.utils.LogUtils.d("获取相册", "获取相册异常：$e", true)
                    ToastUtils.showToast(R.string.img_fail_tip)
                }
            }
        }
