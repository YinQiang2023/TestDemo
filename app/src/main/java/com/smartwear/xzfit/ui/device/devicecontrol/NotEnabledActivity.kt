package com.smartwear.xzfit.ui.device.devicecontrol
...
import com.smartwear.xzfit.databinding.ActivityNotEnabledBinding
...
class NotEnabledActivity : BaseActivity<ActivityNotEnabledBinding, DeviceModel>(
    ...
    override fun initView() {
        super.initView()
//        binding.title.tvCenterTitle.text = getString(R.string.device_info_title)
