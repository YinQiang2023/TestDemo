...
import com.smartwear.xzfit.https.ErrorLogRetrofitClient
import com.smartwear.xzfit.https.HttpCommonAttributes
import com.smartwear.xzfit.https.params.ErrorLogBean
...
//                            })
    ...
    public fun sendEmailError(email: String, type: String) {
        scope.launch {
            val log =
                StringBuffer("time:${com.blankj.utilcode.util.TimeUtils.getNowString(com.smartwear.xzfit.utils.TimeUtils.getSafeDateFormat(TimeUtils.DATEFORMAT_COMM))} , Error email:" + email)
