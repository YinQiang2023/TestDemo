...
public class HttpLog {
    ...
    private static String logTime() {
        Date date = new Date();
        SimpleDateFormat dateFormat = com.smartwear.xzfit.utils.TimeUtils.getSafeDateFormat("yyyy-MM-dd HH:mm:ss:SSS");
        return dateFormat.format(date);
    }

    private static String createFileName() {
        Date date = new Date();
        SimpleDateFormat dateFormat = com.smartwear.xzfit.utils.TimeUtils.getSafeDateFormat("yyyy-MM-dd");
