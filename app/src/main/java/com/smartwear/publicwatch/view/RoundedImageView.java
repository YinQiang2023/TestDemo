...
public class RoundedImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (myDrawable != null && myDrawable instanceof BitmapDrawable && mCornerRadius > 0) {
            ...
            } else if (bgshapeType == 2) {
                canvas.drawRect(rectF.left, rectF.top, rectF.right, rectF.bottom - mCornerRadius, paint);
                canvas.drawRoundRect(rectF.left, rectF.bottom - 2 * mCornerRadius, rectF.right, rectF.bottom, mCornerRadius, mCornerRadius, paint);
            }
    ...
    public void setBgshapeType(int bgshapeType) {
