...
import com.smartwear.publicwatch.databinding.ActivityDebugFirewareUpgradeBinding
...
import com.smartwear.publicwatch.ui.device.DevMoreSetActivity
...
class DebugFirewareUpgradeActivity : BaseActivity<ActivityDebugFirewareUpgradeBinding, DeviceModel>(
    ...
    override fun initView() {
        ...
        binding.tvTip1.text = "操作方法\n\n1.将[OTA文件(.bin)]，放到[内部存储\\Android\\data\\com.smartwear.publicwatch\\otal\\fireware]目录下\n\n\n2.点击[选择文件]按钮，选择文件\n\n\n3.点击[升级]开始升级"
