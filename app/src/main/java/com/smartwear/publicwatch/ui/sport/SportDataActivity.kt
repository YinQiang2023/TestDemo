...
import com.smartwear.publicwatch.databinding.ActivitySportDataBinding
...
//                    locusFragment,
    ...
    override fun initData() {
        ...
        viewModel.sportLiveData.getSportModleInfo().value?.sportTime?.let {
            val item = TimeUtils.millis2String(it * 1000, com.smartwear.publicwatch.utils.TimeUtils.getSafeDateFormat("yyyy-MM-dd HH:mm"))
