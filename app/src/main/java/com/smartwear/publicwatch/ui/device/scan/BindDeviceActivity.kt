...
import com.smartwear.publicwatch.ui.guide.GuideConfigActivity
...
//                                    finishBindDevice()
    ...
    private fun requestService() {
        ...
        viewModel.launchUI {
            try {
                val bean = com.smartwear.publicwatch.https.params.BindDeviceBean()
                ...
                val result = MyRetrofitClient.service.bindDevice(JsonUtils.getRequestJson(TAG, bean, com.smartwear.publicwatch.https.params.BindDeviceBean::class.java))
