...
import com.smartwear.publicwatch.databinding.DialogHeadsetBondFailedBinding
import com.smartwear.publicwatch.databinding.DialogKeExplainBinding
import com.smartwear.publicwatch.db.model.track.TrackingLog
import com.smartwear.publicwatch.dialog.DialogUtils
import com.smartwear.publicwatch.dialog.DialogUtils.DialogClickListener
...
import com.smartwear.publicwatch.ui.device.bean.DeviceScanQrCodeBean
...
object GlobalEventManager {
                ...
                DownloadManager.download(url, listener = object : DownloadListener {
                    ...
                    override fun onSucceed(path: String) {
                        ...
                        SpUtils.setValue(
                            ...
                            TimeUtils.getNowString(com.smartwear.publicwatch.utils.TimeUtils.getSafeDateFormat(com.smartwear.publicwatch.utils.TimeUtils.DATEFORMAT_COMM))
                        )
                        isAGPSDownloading = false
                        if (path != null) {
                            downloadLog.endTime = TrackingLog.getNowString()
    ...
    private fun showKeepLiveExplanationDialog() {
        topActivity.get()?.let { activity ->
            ...
            if (!com.smartwear.publicwatch.BuildConfig.DEBUG) { //debug模式下快速关闭
