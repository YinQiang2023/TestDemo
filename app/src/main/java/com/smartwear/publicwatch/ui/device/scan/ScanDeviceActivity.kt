...
import com.smartwear.publicwatch.databinding.ScanDeviceActivityBinding
...
import com.smartwear.publicwatch.ui.adapter.ScanDeviceAdapter
...
class ScanDeviceActivity : BaseActivity<ScanDeviceActivityBinding, DeviceModel>(ScanDeviceActivityBinding::inflate, DeviceModel::class.java), View.OnClickListener {
    ...
    private fun stopAnimation() {
        ...
        binding.ivScanningRightIcon.setColorFilter(R.color.black)
    ...
    override fun initView() {
        ...
        ivRightIcon?.setColorFilter(R.color.black)
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            binding.layoutTitle.layoutRight.id -> {
                ...
                com.smartwear.publicwatch.utils.PermissionUtils.checkRequestPermissions(
                    this.lifecycle,
                    getString(R.string.permission_camera),
                    com.smartwear.publicwatch.utils.PermissionUtils.PERMISSION_GROUP_CAMERA
                ) {
