...
import com.smartwear.publicwatch.databinding.ActivityAddAlarmClockBinding
...
class AddAlarmClockActivity : BaseActivity<ActivityAddAlarmClockBinding, DeviceModel>(ActivityAddAlarmClockBinding::inflate, DeviceModel::class.java), View.OnClickListener {
    ...
    override fun initData() {
        ...
        if (clockInfo != null) {
            ...
            val newDataString = TimeUtils.getNowString(com.smartwear.publicwatch.utils.TimeUtils.getSafeDateFormat("HH:mm"))
