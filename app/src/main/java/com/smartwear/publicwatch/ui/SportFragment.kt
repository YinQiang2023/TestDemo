...
class SportFragment : BaseFragment<FragmentSportBinding, SportModel>(
    ...
    override fun onDestroyView() {
        ...
        AppUtils.tryBlock {
            ...
            /*java.lang.RuntimeException: Unable to destroy activity {com.smartwear.publicwatch/com.smartwear.publicwatch.ui.HomeActivity}: java.lang.NullPointerException: Attempt to invoke interface method 'boolean com.google.maps.api.android.lib6.impl.bq.W()' on a null object reference
            if (mMapFragment != null && mGoogleMap != null) {
...
//                    viewmodel.getOdometer(mSportType)
    ...
    override fun onVisible() {
        ...
        if (!isInitMap && PermissionUtils.isGranted(*com.smartwear.publicwatch.utils.PermissionUtils.PERMISSION_GROUP_LOCATION)) {
            if (!AppUtils.isEnableGoogleMap()) {
                initAMap()
            } else {
                initGoogleMap()
