...
import com.smartwear.publicwatch.databinding.ActivitySportRecordBinding
import com.smartwear.publicwatch.databinding.ItemSportRecordCommonBinding
...
class SportRecordActivity : BaseActivity<ActivitySportRecordBinding, SportModel>(
    ...
    override fun initView() {
        ...
        mSelectionDate = TimeUtils.getNowString(com.smartwear.publicwatch.utils.TimeUtils.getSafeDateFormat(DateUtils.TIME_YYYY_MM_DD))
        ...
        binding.calendarView.setOnCalendarSelectListener(object :
            ...
            override fun onCalendarSelect(calendar: Calendar, isClick: Boolean) {
                if (isClick) {
                    ...
                    binding.tvDate.text = TimeUtils.millis2String(calendar.timeInMillis, com.smartwear.publicwatch.utils.TimeUtils.getSafeDateFormat(DateUtils.TIME_YYYY_MM))
                }
            }
        })
...
//                )
                ...
                itemBinding.tvStartTime.text = TimeUtils.millis2String(
                    t.sportTime * 1000,
                    com.smartwear.publicwatch.utils.TimeUtils.getSafeDateFormat(com.smartwear.publicwatch.utils.TimeUtils.DATEFORMAT_HOUR_MIN)
                )
                itemBinding.tvTime.text = com.smartwear.publicwatch.utils.TimeUtils.millis2String(t.sportDuration * 1000L)
