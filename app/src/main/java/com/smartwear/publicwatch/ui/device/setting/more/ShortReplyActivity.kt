...
import com.smartwear.publicwatch.databinding.ActivityDevMoreShortReplyBinding
import com.smartwear.publicwatch.databinding.DialogShortReplyBinding
    ...
    override fun initData() {
        ...
        viewModel.getDeviceShortReply(object : ParsingStateManager.SendCmdStateListener(lifecycle) {
            override fun onState(state: SendCmdState) {
                ...
                com.smartwear.publicwatch.utils.ToastUtils.showSendCmdStateTips(state) {
                    finish()
                }
            }
        })
...
//            }
    ...
    private fun showCreateOrEditReplyDialog() {
        if (!ControlBleTools.getInstance().isConnect) {
            com.smartwear.publicwatch.utils.ToastUtils.showToast(R.string.device_no_connection)
            return
        }
