...
import com.smartwear.publicwatch.databinding.FragmentHealthyBinding
...
import com.smartwear.publicwatch.ui.healthy.EditCardActivity
import com.smartwear.publicwatch.ui.healthy.history.*
import com.smartwear.publicwatch.ui.healthy.history.womenhealth.WomenHealthActivity
import com.smartwear.publicwatch.ui.livedata.RefreshHealthyFragment
import com.smartwear.publicwatch.ui.sport.SportRecordActivity
...
import com.smartwear.publicwatch.ui.healthy.history.StressActivity
import com.smartwear.publicwatch.ui.healthy.bean.SyncDailyInfoBean
import com.smartwear.publicwatch.ui.healthy.ecg.EcgActivity
import com.smartwear.publicwatch.ui.healthy.history.womenhealth.WomenPeriodSettingActivity
...
//        binding.ivEditCard.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG) //下划线
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            if (!PermissionUtils.isGranted(*com.smartwear.publicwatch.utils.PermissionUtils.PERMISSION_BLE12)) {
                binding.ivBluetoothState.visibility = View.GONE
            }
        }
        //蓝牙未开启
                    ...
                    getString(R.string.healthy_sports_list_sport_record) -> {
                        if (!isNoData(v.healthyItemBottom, t.context)) {
                            ...
                            v.healthyItemBottom.text = SpannableStringTool.get()
                                .append(TimeUtils.millis2String(t.bottomText.toLong(), com.smartwear.publicwatch.utils.TimeUtils.getSafeDateFormat("MM/dd")))
                                .setFontSize(12f)
                                .setForegroundColor(ContextCompat.getColor(requireContext(),R.color.color_878787))
                                .append("   ")
                                .append(TimeUtils.millis2String(t.bottomText.toLong(), com.smartwear.publicwatch.utils.TimeUtils.getSafeDateFormat("HH:mm")))
                                .setFontSize(12f)
                                .setForegroundColor(ContextCompat.getColor(requireContext(),R.color.color_878787))
                                .create()
