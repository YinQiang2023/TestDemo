...
import com.smartwear.publicwatch.databinding.ActivityDebugBinding
...
import com.smartwear.publicwatch.ui.debug.manager.DebugAppBean
...
class DebugActivity : BaseActivity<ActivityDebugBinding, DeviceModel>(
    ...
    private fun changeDevice() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            if (!com.blankj.utilcode.util.PermissionUtils.isGranted(*com.smartwear.publicwatch.utils.PermissionUtils.PERMISSION_BLE12)) {
