...
import com.smartwear.publicwatch.databinding.ActivityDebugNoticeBinding
import com.smartwear.publicwatch.ui.debug.bean.NoticeSpinnerItem
        ...
        when (v?.id) {
            ...
            binding.btnStart1.id -> {
                ...
                if (binding.btnStart1.isSelected) {
                    ...
                    binding.btnStart1.setBackgroundColor(getColor(com.smartwear.publicwatch.R.color.teal_200))
                ...
                if (binding.btnStart1.isSelected) {
                    ...
                    binding.btnLast.setBackgroundColor(getColor(com.smartwear.publicwatch.R.color.teal_200))
                    binding.btnNext.setBackgroundColor(getColor(com.smartwear.publicwatch.R.color.teal_200))
                }
