...
class SleepLatelyResponse {
    ...
    var sectionList = mutableListOf<Data>()//--睡眠分段数据
    ...
    override fun toString(): String {
        return "SleepLatelyResponse(startSleepTimestamp='$startSleepTimestamp', date='$date', endSleepTimestamp='$endSleepTimestamp', sleepDuration='$sleepDuration', sleepScore='$sleepScore', awakeTime='$awakeTime', awakeTimePercentage='$awakeTimePercentage', lightSleepTime='$lightSleepTime', lightSleepTimePercentage='$lightSleepTimePercentage', deepSleepTime='$deepSleepTime', deepSleepTimePercentage='$deepSleepTimePercentage', rapidEyeMovementTime='$rapidEyeMovementTime', rapidEyeMovementTimePercentage='$rapidEyeMovementTimePercentage', sectionList=$sectionList)"
    }
