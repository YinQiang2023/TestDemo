...
import com.smartwear.publicwatch.base.BaseApplication.Companion.mContext
...
import com.smartwear.publicwatch.utils.CommonAttributes
...
//        sslSocketFactory?.let { trustManager?.let { it1 -> builder.sslSocketFactory(it, it1) } }
    ...
    val service by lazy {
        getService(ErrorLogService::class.java, AppUtils.getMetaDataByKey("com.smartwear.publicwatch.serverUrl"))
    }
