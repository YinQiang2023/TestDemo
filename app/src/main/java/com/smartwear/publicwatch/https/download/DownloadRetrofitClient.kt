...
internal object DownloadRetrofitClient {
    //国内
    private val mBaseURL: String by lazy { AppUtils.getMetaDataByKey("com.smartwear.publicwatch.serverUrl")!! }

    //国外
    private val mBaseEnURL: String by lazy { AppUtils.getMetaDataByKey("com.smartwear.publicwatch.foreignServerUrl")!! }
