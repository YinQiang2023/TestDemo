package com.smartwear.publicwatch.https.tracking
...
interface TrackingApi {
     ...
     * @see com.smartwear.publicwatch.https.params.TrackingAppParam
     */
    @POST("app/error/bulk")
     ...
     * @see com.smartwear.publicwatch.https.params.UserBehaviorParam
     */
    @POST("app/use/bulk")
     ...
     * @see com.smartwear.publicwatch.https.params.DevTrackingParam
     */
    @POST("dev/log/bulk")
