package com.smartwear.publicwatch.https.x509;
...
//        return new X509Certificate[0];
    ...
    public static void allowAllSSL() {
        HttpsURLConnection.setDefaultHostnameVerifier(new ZhHostnameVerifier());
    ...
    public static void allowAssignSSL() {
        HttpsURLConnection.setDefaultHostnameVerifier(new ZhHostnameVerifier());
        ...
        HttpsURLConnection.setDefaultSSLSocketFactory(HTTPSTrustManager.getSslSocketFactory(HTTPSTrustManager.getAssetsInputStream("h3ca.cer"), null, null));// client信任指定证书
    }

    public static InputStream getAssetsInputStream(String name) {
        try {
            return BaseApplication.mContext.getAssets().open(name);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
