...
public class DisableCameraReceiver extends BroadcastReceiver {
    private static final String TAG = DisableCameraReceiver.class.getSimpleName();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        LogUtils.e(TAG, "onReceive intent = " + intent.getAction());
        ...
        disableComponent(context, "com.smartwear.publicwatch.receiver.DisableCameraReceiver");
    }
