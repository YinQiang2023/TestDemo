...
import com.smartwear.publicwatch.https.params.QueryExerciseDetailsParam
import com.smartwear.publicwatch.https.params.QueryExerciseListParam
import com.smartwear.publicwatch.https.response.SportExerciseResponse
import com.smartwear.publicwatch.ui.data.Global
import com.smartwear.publicwatch.ui.sport.bean.SportDataBean
import com.smartwear.publicwatch.ui.sport.livedata.SportLiveData
                            ...
                            serData.list!!.forEach { ser ->
                                ...
                                if (sqlBean != null) {
                                    ...
                                    ser.date = TimeUtils.millis2String(
                                        ser.sportTime * 1000,
                                        com.smartwear.publicwatch.utils.TimeUtils.getSafeDateFormat(com.smartwear.publicwatch.utils.TimeUtils.DATEFORMAT_COMM)
                                    )
