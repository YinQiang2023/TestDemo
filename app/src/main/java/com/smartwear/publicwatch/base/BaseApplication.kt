...
import com.smartwear.publicwatch.receiver.*
import com.smartwear.publicwatch.service.LocationService
import com.smartwear.publicwatch.service.MyNotificationsService
import com.smartwear.publicwatch.ui.DeviceFragment
import com.smartwear.publicwatch.ui.GlobalEventManager
import com.smartwear.publicwatch.ui.HealthyFragment
import com.smartwear.publicwatch.ui.WelcomeActivity
...
class BaseApplication : Application(), OnMapsSdkInitializedCallback {
    companion object {
        ...
        fun initDataReduction() {
            com.smartwear.publicwatch.utils.AppUtils.tryBlock {
    ...
    override fun onCreate() {
        ...
        if (packageName == name) {
            ...
            //debug log
            LogUtils.getConfig().setLogSwitch(com.smartwear.publicwatch.utils.AppUtils.isBetaApp()).setBorderSwitch(false)
    ...
    fun initControlBleTools(context: Context) {
        //设备日志 仅测试版本写日志
        val isWriteLog = com.smartwear.publicwatch.utils.AppUtils.isBetaApp()
        ...
        if (ControlBleTools.getInstance().isInit) {
            com.smartwear.publicwatch.utils.LogUtils.d("SDK", "initControlBleTools return : isInit == true")
            return
        }
    ...
    class NotificationServiceConnection : ServiceConnection {
        override fun onServiceConnected(name: ComponentName?, service: IBinder?) {
            com.smartwear.publicwatch.utils.LogUtils.d("MyNotificationsService", "onServiceConnected:$name")
        }

        override fun onServiceDisconnected(name: ComponentName?) {
            com.smartwear.publicwatch.utils.LogUtils.d("MyNotificationsService", "onServiceDisconnected:$name")
        }
    }
    //endregion
    ...
    private fun initBetaFireWareUpPath() {
        if (com.smartwear.publicwatch.utils.AppUtils.isBetaApp()) {
    ...
    private fun initNetWorkListener() {
        ...
        NetworkUtils.registerNetworkStatusChangedListener(object : NetworkUtils.OnNetworkStatusChangedListener {
            override fun onDisconnected() {
                ...
                com.smartwear.publicwatch.utils.LogUtils.e("NetWork", "网络断开连接", true)
            ...
            override fun onConnected(networkType: NetworkUtils.NetworkType?) {
                ...
                com.smartwear.publicwatch.utils.LogUtils.e("NetWork", "网络连接上", true)
                //刷新设备语言列表
            ...
            override fun onActivityDestroyed(activity: Activity) {
                ...
                ThreadUtils.runOnUiThreadDelayed({
                    ...
                    if (ActivityUtils.getActivityList().size == 0) {
                        com.smartwear.publicwatch.utils.LogUtils.e("sdk release", "live Activity size == 0")
                        //清除sdk内部设备信息
