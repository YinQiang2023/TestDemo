...
import com.smartwear.publicwatch.https.params.TraceLogBean
...
//            SpUtils.getSPUtilsInstance().put(SpUtils.WEATHER_SWITCH, false)
        ...
        //清除sdk内部设备信息
        com.smartwear.publicwatch.utils.LogUtils.e("sdk release","user loginout")
    ...
    fun traceSave(page: String, module: String, value: String,msgLog:String? = null) {
        launchUI {
            try {
                ...
                traceLogBean.phoneType = com.smartwear.publicwatch.utils.AppUtils.getPhoneType()
                traceLogBean.phoneSystemVersion = com.smartwear.publicwatch.utils.AppUtils.getOsVersion()
