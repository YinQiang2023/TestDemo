...
//    }
    ...
    fun setUserInformation() {
        if (ControlBleTools.getInstance().isConnect) {
            ...
            val userProfile = UserInfo()
            userProfile.age =
                DateUtils.getAgeFromBirthTime(TimeUtils.string2Date(mUserBean.birthDate, com.smartwear.publicwatch.utils.TimeUtils.getSafeDateFormat(DateUtils.TIME_YYYY_MM_DD)))
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            if (!PermissionUtils.isGranted(*com.smartwear.publicwatch.utils.PermissionUtils.PERMISSION_BLE12)) {
                ...
                com.smartwear.publicwatch.utils.PermissionUtils.checkRequestPermissions(
                    ...
                    com.smartwear.publicwatch.utils.PermissionUtils.PERMISSION_BLE12
                ) {
