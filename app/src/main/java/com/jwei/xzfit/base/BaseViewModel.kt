...
import com.jwei.xzfit.https.params.TraceLogBean
...
//            SpUtils.getSPUtilsInstance().put(SpUtils.WEATHER_SWITCH, false)
        ...
        //清除sdk内部设备信息
        com.jwei.xzfit.utils.LogUtils.e("sdk release","user loginout")
    ...
    fun traceSave(page: String, module: String, value: String,msgLog:String? = null) {
        launchUI {
            try {
                ...
                traceLogBean.phoneType = com.jwei.xzfit.utils.AppUtils.getPhoneType()
                traceLogBean.phoneSystemVersion = com.jwei.xzfit.utils.AppUtils.getOsVersion()
