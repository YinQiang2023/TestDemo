...
object AppUtils {
    ...
    fun tryBlock(toast: String = "", block: () -> Unit) {
        try {
            ...
            e.printStackTrace()
            com.jwei.xzfit.utils.LogUtils.e("AppUtils", "tryBlock = $e", true)
            if (toast.isNotEmpty()) {
    ...
    fun createImageFile(): File? {
        ...
        val path = "${Global.LUBAN_CACHE_DIR}${File.separator}${TimeUtils.date2String(Date(), com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat("yyyyMMdd_HHmmss_SSS"))}.png"
