...
import com.jwei.xzfit.https.ErrorLogRetrofitClient
import com.jwei.xzfit.https.HttpCommonAttributes
import com.jwei.xzfit.https.params.ErrorLogBean
...
//                            })
    ...
    public fun sendEmailError(email: String, type: String) {
        scope.launch {
            val log =
                StringBuffer("time:${com.blankj.utilcode.util.TimeUtils.getNowString(com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat(TimeUtils.DATEFORMAT_COMM))} , Error email:" + email)
