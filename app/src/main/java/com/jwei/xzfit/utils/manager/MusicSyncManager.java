...
public class MusicSyncManager {
    ...
    private void auxiliaryMusicTitle(String packageName) {
        ...
        if (TextUtils.isEmpty(aName)) {
            //日志记录到文件
            com.jwei.xzfit.utils.LogUtils.i(TAG, "系统当前的媒体控制器获取音乐信息失败 --->packname=" + packageName + ",Metadata==null&Notification_title==null");
        }
        if (!TextUtils.isEmpty(aName)) {
            mMusicTitle = aName;
        }
    ...
    class MediaControllerCallBack extends MediaController.Callback {
        ...
        public void onPlaybackStateChanged(@Nullable PlaybackState state) {
            ...
            try {
                ...
                e.printStackTrace();
                com.jwei.xzfit.utils.LogUtils.e(TAG, "onPlaybackStateChanged:" + e);
            }
        }
