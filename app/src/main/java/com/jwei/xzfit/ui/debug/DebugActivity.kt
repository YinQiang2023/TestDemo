...
import com.jwei.xzfit.databinding.ActivityDebugBinding
...
import com.jwei.xzfit.ui.debug.manager.DebugAppBean
...
class DebugActivity : BaseActivity<ActivityDebugBinding, DeviceModel>(
    ...
    private fun changeDevice() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            if (!com.blankj.utilcode.util.PermissionUtils.isGranted(*com.jwei.xzfit.utils.PermissionUtils.PERMISSION_BLE12)) {
