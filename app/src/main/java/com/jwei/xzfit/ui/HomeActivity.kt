...
import com.jwei.xzfit.databinding.DialogPerExplainBinding
import com.jwei.xzfit.databinding.HomeActivityBinding
...
import com.jwei.xzfit.ui.adapter.FragmentAdapter
import com.jwei.xzfit.ui.data.Global
import com.jwei.xzfit.ui.user.AppUpdateManager
import com.jwei.xzfit.ui.user.UpdateInfoService
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == SET_NOTIFICATION_REQUEST_CODE) { // resultCode = 0 , data = null
            if (NotificationUtils.areNotificationsEnabled(this)) {
                //重启蓝牙服务重启app通知
                if (AppUtils.isOpenBluetooth()) {
                    com.jwei.xzfit.utils.LogUtils.e("sdk release","Notification permission authorization")
