...
import com.jwei.xzfit.databinding.BindDeviceActivityBinding
import com.jwei.xzfit.dialog.DialogUtils
import com.jwei.xzfit.https.HttpCommonAttributes
import com.jwei.xzfit.ui.device.devicecontrol.EnableDeviceActivity
...
import com.jwei.xzfit.ui.guide.GuideConfigActivity
...
//                                    finishBindDevice()
    ...
    private fun requestService() {
        ...
        viewModel.launchUI {
            try {
                val bean = com.jwei.xzfit.https.params.BindDeviceBean()
                ...
                val result = MyRetrofitClient.service.bindDevice(JsonUtils.getRequestJson(TAG, bean, com.jwei.xzfit.https.params.BindDeviceBean::class.java))
