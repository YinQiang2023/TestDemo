...
import com.jwei.xzfit.databinding.ActivityDebugNoticeBinding
import com.jwei.xzfit.ui.debug.bean.NoticeSpinnerItem
        ...
        when (v?.id) {
            ...
            binding.btnStart1.id -> {
                ...
                if (binding.btnStart1.isSelected) {
                    ...
                    binding.btnStart1.setBackgroundColor(getColor(com.jwei.xzfit.R.color.teal_200))
                ...
                if (binding.btnStart1.isSelected) {
                    ...
                    binding.btnLast.setBackgroundColor(getColor(com.jwei.xzfit.R.color.teal_200))
                    binding.btnNext.setBackgroundColor(getColor(com.jwei.xzfit.R.color.teal_200))
                }
