...
import com.jwei.xzfit.databinding.ActivitySportRecordBinding
import com.jwei.xzfit.databinding.ItemSportRecordCommonBinding
...
class SportRecordActivity : BaseActivity<ActivitySportRecordBinding, SportModel>(
    ...
    override fun initView() {
        ...
        mSelectionDate = TimeUtils.getNowString(com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat(DateUtils.TIME_YYYY_MM_DD))
        ...
        binding.calendarView.setOnCalendarSelectListener(object :
            ...
            override fun onCalendarSelect(calendar: Calendar, isClick: Boolean) {
                if (isClick) {
                    ...
                    binding.tvDate.text = TimeUtils.millis2String(calendar.timeInMillis, com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat(DateUtils.TIME_YYYY_MM))
                }
            }
        })
...
//                )
                ...
                itemBinding.tvStartTime.text = TimeUtils.millis2String(
                    t.sportTime * 1000,
                    com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat(com.jwei.xzfit.utils.TimeUtils.DATEFORMAT_HOUR_MIN)
                )
                itemBinding.tvTime.text = com.jwei.xzfit.utils.TimeUtils.millis2String(t.sportDuration * 1000L)
