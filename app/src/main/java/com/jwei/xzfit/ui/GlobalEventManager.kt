...
import com.jwei.xzfit.databinding.DialogHeadsetBondFailedBinding
import com.jwei.xzfit.databinding.DialogKeExplainBinding
import com.jwei.xzfit.db.model.track.TrackingLog
import com.jwei.xzfit.dialog.DialogUtils
import com.jwei.xzfit.dialog.DialogUtils.DialogClickListener
...
import com.jwei.xzfit.https.download.DownloadListener
import com.jwei.xzfit.https.download.DownloadManager
import com.jwei.xzfit.https.response.AgpsResponse
import com.jwei.xzfit.https.response.FirewareUpgradeResponse
import com.jwei.xzfit.https.response.ProductListResponse
...
object GlobalEventManager {
                ...
                DownloadManager.download(url, listener = object : DownloadListener {
                    ...
                    override fun onSucceed(path: String) {
                        ...
                        SpUtils.setValue(
                            ...
                            TimeUtils.getNowString(com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat(com.jwei.xzfit.utils.TimeUtils.DATEFORMAT_COMM))
                        )
                        isAGPSDownloading = false
                        if (path != null) {
                            downloadLog.endTime = TrackingLog.getNowString()
    ...
    private fun showKeepLiveExplanationDialog() {
        topActivity.get()?.let { activity ->
            ...
            if (!com.jwei.xzfit.BuildConfig.DEBUG) { //debug模式下快速关闭
