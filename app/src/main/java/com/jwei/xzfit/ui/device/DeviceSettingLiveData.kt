...
import com.jwei.xzfit.base.UnFlawedLiveData
import com.zhapp.ble.bean.*
import com.zhapp.ble.callback.*
import com.zhapp.ble.utils.ConnectTrackingUtils
...
import com.jwei.xzfit.https.params.DisconnectionBean
...
import com.jwei.xzfit.utils.JsonUtils
...
//            }
        ...
        CallBackUtils.setFirmwareTrackingLogCallBack(object : FirmwareTrackingLogCallBack {
            override fun onTrackingLog(trackingLogBean: TrackingLogBean?) {
                if (trackingLogBean != null) {
                    ...
                    com.jwei.xzfit.utils.LogUtils.d("FirmwareTracking","设备埋点日志：" + trackingLogBean.fileName + ",\n" + ConvertUtils.bytes2String(trackingLogBean.trackingLog, "UTF-8"))
        ...
        //
        ConnectTrackingUtils.setTrackingListener(object :ConnectTrackingUtils.ConnectTrackingListener{
            override fun onPostLog(log: String) {
                /*if(!TextUtils.equals(connectTrackingLastLog,log)) {
                    connectTrackingLastLog = log
                    AppTrackingManager.trackingModule(AppTrackingManager.MODULE_RECONNECT, TrackingLog.getAppTypeTrack("连接超时/失败").apply {
                        this.log = log ?: ""
                    }, "1313", true)
                }*/
            }
