...
import com.jwei.xzfit.databinding.ActivitySportDataBinding
...
//                    locusFragment,
    ...
    override fun initData() {
        ...
        viewModel.sportLiveData.getSportModleInfo().value?.sportTime?.let {
            val item = TimeUtils.millis2String(it * 1000, com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat("yyyy-MM-dd HH:mm"))
    ...
    override fun onClick(v: View?) {
        if (v?.id == ivRightIcon?.id) {
            com.jwei.xzfit.utils.PermissionUtils.checkRequestPermissions(
                ...
                com.jwei.xzfit.utils.PermissionUtils.PERMISSION_GROUP_SDCARD
            ) {
                share()
            }
        }
