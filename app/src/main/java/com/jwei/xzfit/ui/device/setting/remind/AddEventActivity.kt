...
import com.jwei.xzfit.databinding.ActivityAddEventBinding
import com.jwei.xzfit.dialog.DialogUtils
import com.jwei.xzfit.view.wheelview.DatePicker
import com.jwei.xzfit.view.wheelview.TimePicker
import com.jwei.xzfit.view.wheelview.annotation.TimeMode
import com.jwei.xzfit.view.wheelview.entity.DateEntity
import com.jwei.xzfit.view.wheelview.entity.TimeEntity
import com.jwei.xzfit.view.wheelview.widget.DateWheelLayout
...
import com.jwei.xzfit.utils.ProhibitEmojiUtils
...
class AddEventActivity : BaseActivity<ActivityAddEventBinding, DeviceModel>(
    ...
    override fun initView() {
        ...
        binding.tvDate.text = TimeUtils.getNowString(com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat("yyyy-MM-dd"))
        ...
        binding.tvTime.text = TimeUtils.date2String(Date(), com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat(com.jwei.xzfit.utils.TimeUtils.DATEFORMAT_HOUR_MIN))
...
//            }
    ...
    private fun createTimeDialog(inHour: Int, inMinute: Int) {
        ...
        AppUtils.tryBlock {
            isTody = TimeUtils.isToday(dateString, com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat("yyyy-MM-dd"))
        }
    ...
    private fun returnEventInfo(isIgnoreTime: Boolean = false) {
        ...
        val span = TimeUtils.getTimeSpan(
            TimeUtils.string2Date("$date $time", com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat(com.jwei.xzfit.utils.TimeUtils.DATEFORMAT_COM_YYMMDD_HHMM)),
