...
import com.jwei.xzfit.databinding.ScanDeviceActivityBinding
...
import com.jwei.xzfit.ui.adapter.ScanDeviceAdapter
        ...
        when (v?.id) {
            ...
            binding.layoutTitle.layoutRight.id -> {
                ...
                com.jwei.xzfit.utils.PermissionUtils.checkRequestPermissions(
                    ...
                    com.jwei.xzfit.utils.PermissionUtils.PERMISSION_GROUP_CAMERA
                ) {
