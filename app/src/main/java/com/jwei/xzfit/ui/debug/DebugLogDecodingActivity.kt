...
import com.jwei.xzfit.databinding.ActivityDebugLogDecodingBinding
...
import com.jwei.xzfit.utils.AESUtils
import com.jwei.xzfit.utils.AppUtils
import com.jwei.xzfit.utils.SaveLog
            ...
            return@withContext withTimeoutOrNull(300 * 1000) {
                suspendCancellableCoroutine {
                    try {
                        ...
                        for (log in cs) {
                            val newLog = StringBuffer(AESUtils.decrypt(log, com.jwei.xzfit.utils.JsonUtils.serviceKey)).append("\n")
