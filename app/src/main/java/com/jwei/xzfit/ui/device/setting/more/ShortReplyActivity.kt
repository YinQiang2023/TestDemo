...
import com.jwei.xzfit.databinding.ActivityDevMoreShortReplyBinding
import com.jwei.xzfit.databinding.DialogShortReplyBinding
    ...
    override fun initData() {
        ...
        viewModel.getDeviceShortReply(object : ParsingStateManager.SendCmdStateListener(lifecycle) {
            override fun onState(state: SendCmdState) {
                ...
                com.jwei.xzfit.utils.ToastUtils.showSendCmdStateTips(state) {
                    finish()
                }
            }
        })
...
//            }
    ...
    private fun showCreateOrEditReplyDialog() {
        if (!ControlBleTools.getInstance().isConnect) {
            com.jwei.xzfit.utils.ToastUtils.showToast(R.string.device_no_connection)
            return
        }
