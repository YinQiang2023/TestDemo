...
import com.jwei.xzfit.databinding.*
import com.jwei.xzfit.dialog.DialogUtils
import com.jwei.xzfit.https.HttpCommonAttributes
import com.jwei.xzfit.ui.adapter.FeedbackImgItem
import com.jwei.xzfit.ui.adapter.FeedbackScreenshotsAdapter
...
import com.jwei.xzfit.utils.RegexUtils
...
import com.jwei.xzfit.view.wheelview.widget.FeedbackDatePicker
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_SELECT_PICTURE_FOR_UPLOAD) {
                try {
                    ...
                    e.printStackTrace()
                    com.jwei.xzfit.utils.LogUtils.d("获取相册", "获取相册异常：$e", true)
                    ToastUtils.showToast(R.string.img_fail_tip)
                }
            }
        }
