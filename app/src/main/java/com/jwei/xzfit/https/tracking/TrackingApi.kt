package com.jwei.xzfit.https.tracking
...
interface TrackingApi {
     ...
     * @see com.jwei.xzfit.https.params.TrackingAppParam
     */
    @POST("app/error/bulk")
     ...
     * @see com.jwei.xzfit.https.params.UserBehaviorParam
     */
    @POST("app/use/bulk")
     ...
     * @see com.jwei.xzfit.https.params.DevTrackingParam
     */
    @POST("dev/log/bulk")
