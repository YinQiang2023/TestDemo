...
import com.jwei.xzfit.view.wheelview.contract.OnNumberPickedListener;
import com.jwei.xzfit.view.wheelview.contract.WheelFormatter;
import com.jwei.xzfit.view.wheelview.widget.NumberWheelLayout;
...
public class NumberPicker extends ConfirmPicker {
    ...
    public void setRangeStep(int min, int max, int step) {
        wheelLayout.setRangeStep(min, max, step);
    }
