...
import com.jwei.xzfit.https.params.QueryExerciseDetailsParam
import com.jwei.xzfit.https.params.QueryExerciseListParam
import com.jwei.xzfit.https.response.SportExerciseResponse
import com.jwei.xzfit.ui.data.Global
import com.jwei.xzfit.ui.sport.bean.SportDataBean
import com.jwei.xzfit.ui.sport.livedata.SportLiveData
                            ...
                            serData.list!!.forEach { ser ->
                                ...
                                if (sqlBean != null) {
                                    ...
                                    ser.date = TimeUtils.millis2String(
                                        ser.sportTime * 1000,
                                        com.jwei.xzfit.utils.TimeUtils.getSafeDateFormat(com.jwei.xzfit.utils.TimeUtils.DATEFORMAT_COMM)
                                    )
