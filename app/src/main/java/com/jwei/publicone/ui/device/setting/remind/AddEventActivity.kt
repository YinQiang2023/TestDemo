...
import com.jwei.publicone.databinding.ActivityAddEventBinding
import com.jwei.publicone.dialog.DialogUtils
import com.jwei.publicone.view.wheelview.DatePicker
import com.jwei.publicone.view.wheelview.TimePicker
...
import com.jwei.publicone.utils.ProhibitEmojiUtils
...
class AddEventActivity : BaseActivity<ActivityAddEventBinding, DeviceModel>(
    ...
    override fun initView() {
        ...
        binding.tvDate.text = TimeUtils.getNowString(com.jwei.publicone.utils.TimeUtils.getSafeDateFormat("yyyy-MM-dd"))
        ...
        binding.tvTime.text = TimeUtils.date2String(Date(), com.jwei.publicone.utils.TimeUtils.getSafeDateFormat(com.jwei.publicone.utils.TimeUtils.DATEFORMAT_HOUR_MIN))
...
//            }
    ...
    private fun createTimeDialog(inHour: Int, inMinute: Int) {
        ...
        AppUtils.tryBlock {
            isTody = TimeUtils.isToday(dateString, com.jwei.publicone.utils.TimeUtils.getSafeDateFormat("yyyy-MM-dd"))
        }
    ...
    private fun returnEventInfo(isIgnoreTime: Boolean = false) {
        ...
        val span = TimeUtils.getTimeSpan(
            TimeUtils.string2Date("$date $time", com.jwei.publicone.utils.TimeUtils.getSafeDateFormat(com.jwei.publicone.utils.TimeUtils.DATEFORMAT_COM_YYMMDD_HHMM)),
