...
import com.jwei.publicone.databinding.FragmentHealthyBinding
import com.jwei.publicone.databinding.ItemHealthyFragmentBinding
import com.jwei.publicone.ui.adapter.MultiItemCommonAdapter
import com.jwei.publicone.ui.healthy.bean.HealthyItemBean
...
import com.jwei.publicone.ui.healthy.EditCardActivity
import com.jwei.publicone.ui.healthy.history.*
import com.jwei.publicone.ui.healthy.history.womenhealth.WomenHealthActivity
import com.jwei.publicone.ui.livedata.RefreshHealthyFragment
import com.jwei.publicone.ui.sport.SportRecordActivity
...
import com.jwei.publicone.ui.healthy.history.StressActivity
import com.jwei.publicone.ui.healthy.bean.SyncDailyInfoBean
import com.jwei.publicone.ui.healthy.ecg.EcgActivity
import com.jwei.publicone.ui.healthy.history.womenhealth.WomenPeriodSettingActivity
import com.jwei.publicone.ui.livedata.RefreshBatteryState
import com.jwei.publicone.ui.livedata.RefreshHealthyMainData
import com.jwei.publicone.ui.livedata.bean.BatteryBean
...
//        binding.ivEditCard.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG) //下划线
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            if (!PermissionUtils.isGranted(*com.jwei.publicone.utils.PermissionUtils.PERMISSION_BLE12)) {
                binding.ivBluetoothState.visibility = View.GONE
            }
        }
        //蓝牙未开启
                    ...
                    getString(R.string.healthy_sports_list_sport_record) -> {
                        if (!isNoData(v.healthyItemBottom, t.context)) {
                            ...
                            v.healthyItemBottom.text = SpannableStringTool.get()
                                .append(TimeUtils.millis2String(t.bottomText.toLong(), com.jwei.publicone.utils.TimeUtils.getSafeDateFormat("MM/dd")))
                                .setFontSize(12f)
                                .setForegroundColor(Color.WHITE)
                                .append("   ")
                                .append(TimeUtils.millis2String(t.bottomText.toLong(), com.jwei.publicone.utils.TimeUtils.getSafeDateFormat("HH:mm")))
                                .setFontSize(12f)
                                .setForegroundColor(Color.WHITE)
                                .create()
