...
import com.jwei.publicone.databinding.ActivityOfflineStressBinding
import com.jwei.publicone.dialog.DialogUtils
import com.jwei.publicone.https.HttpCommonAttributes
import com.jwei.publicone.https.response.SinglePressureListResponse
import com.jwei.publicone.https.response.SinglePressureResponse
import com.jwei.publicone.ui.data.Global
import com.jwei.publicone.ui.view.BloodOxygenView
import com.jwei.publicone.ui.view.OfflineStressView
...
class OfflineStressActivity : BaseActivity<ActivityOfflineStressBinding, DailyModel>(ActivityOfflineStressBinding::inflate, DailyModel::class.java), View.OnClickListener {
    ...
    override fun initView() {
        super.initView()
        binding.title.tvTitle.text = getString(R.string.healthy_pressure_title)
