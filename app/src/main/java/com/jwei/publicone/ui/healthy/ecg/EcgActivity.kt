...
import com.jwei.publicone.databinding.ActivityEcgBinding
import com.jwei.publicone.databinding.ItemEcgBinding
    ...
    private fun initAdapter(): MultiItemCommonAdapter<Ecg, ItemEcgBinding> {
        return object : MultiItemCommonAdapter<Ecg, ItemEcgBinding>(ecgList) {
            ...
            override fun convert(v: ItemEcgBinding, t: Ecg, position: Int) {
                ...
                v.tvTime.text = com.jwei.publicone.utils.TimeUtils.AllTimeToTime(t.healthMeasuringTime)
