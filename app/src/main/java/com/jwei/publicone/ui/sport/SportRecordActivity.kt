...
import com.jwei.publicone.databinding.ActivitySportRecordBinding
import com.jwei.publicone.databinding.ItemSportRecordCommonBinding
...
class SportRecordActivity : BaseActivity<ActivitySportRecordBinding, SportModel>(
    ...
    override fun initView() {
        ...
        mSelectionDate = TimeUtils.getNowString(com.jwei.publicone.utils.TimeUtils.getSafeDateFormat(DateUtils.TIME_YYYY_MM_DD))
        ...
        binding.calendarView.setOnCalendarSelectListener(object :
            ...
            override fun onCalendarSelect(calendar: Calendar, isClick: Boolean) {
                if (isClick) {
                    ...
                    binding.tvDate.text = TimeUtils.millis2String(calendar.timeInMillis, com.jwei.publicone.utils.TimeUtils.getSafeDateFormat(DateUtils.TIME_YYYY_MM))
                }
            }
        })
...
//                )
                ...
                itemBinding.tvStartTime.text = TimeUtils.millis2String(
                    t.sportTime * 1000,
                    com.jwei.publicone.utils.TimeUtils.getSafeDateFormat(com.jwei.publicone.utils.TimeUtils.DATEFORMAT_HOUR_MIN)
                )
                itemBinding.tvTime.text = com.jwei.publicone.utils.TimeUtils.millis2String(t.sportDuration * 1000L)
