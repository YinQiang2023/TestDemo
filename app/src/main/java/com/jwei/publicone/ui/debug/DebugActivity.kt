...
import com.jwei.publicone.databinding.ActivityDebugBinding
import com.jwei.publicone.databinding.DialogDebugBinListBinding
...
import com.jwei.publicone.ui.debug.manager.DebugAppBean
...
class DebugActivity : BaseActivity<ActivityDebugBinding, DeviceModel>(
    ...
    private fun changeDevice() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            if (!com.blankj.utilcode.util.PermissionUtils.isGranted(*com.jwei.publicone.utils.PermissionUtils.PERMISSION_BLE12)) {
