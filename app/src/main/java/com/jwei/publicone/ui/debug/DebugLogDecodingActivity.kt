...
import com.jwei.publicone.databinding.ActivityDebugLogDecodingBinding
...
import com.jwei.publicone.utils.SaveLog
            ...
            return@withContext withTimeoutOrNull(300 * 1000) {
                suspendCancellableCoroutine {
                    try {
                        ...
                        for (log in cs) {
                            val newLog = StringBuffer(AESUtils.decrypt(log, com.jwei.publicone.utils.JsonUtils.serviceKey)).append("\n")
