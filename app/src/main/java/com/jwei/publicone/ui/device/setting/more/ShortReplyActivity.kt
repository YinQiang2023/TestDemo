...
import com.jwei.publicone.databinding.ActivityDevMoreShortReplyBinding
import com.jwei.publicone.databinding.DialogShortReplyBinding
    ...
    override fun initData() {
        ...
        viewModel.getDeviceShortReply(object : ParsingStateManager.SendCmdStateListener(lifecycle) {
            override fun onState(state: SendCmdState) {
                ...
                com.jwei.publicone.utils.ToastUtils.showSendCmdStateTips(state) {
                    finish()
                }
            }
        })
...
//            }
    ...
    private fun showCreateOrEditReplyDialog() {
        if (!ControlBleTools.getInstance().isConnect) {
            com.jwei.publicone.utils.ToastUtils.showToast(R.string.device_no_connection)
            return
        }
