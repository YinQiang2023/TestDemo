...
import com.jwei.publicone.ui.adapter.FeedbackImgItem
import com.jwei.publicone.ui.adapter.FeedbackScreenshotsAdapter
...
import com.jwei.publicone.utils.RegexUtils
...
import com.jwei.publicone.view.wheelview.widget.FeedbackDatePicker
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_SELECT_PICTURE_FOR_UPLOAD) {
                try {
                    ...
                    e.printStackTrace()
                    com.jwei.publicone.utils.LogUtils.d("获取相册", "获取相册异常：$e", true)
                    ToastUtils.showToast(R.string.img_fail_tip)
                }
            }
        }
