...
import com.jwei.publicone.databinding.BindDeviceActivityBinding
import com.jwei.publicone.dialog.DialogUtils
import com.jwei.publicone.https.HttpCommonAttributes
import com.jwei.publicone.ui.device.devicecontrol.EnableDeviceActivity
...
import com.jwei.publicone.ui.guide.GuideConfigActivity
...
//                                    finishBindDevice()
    ...
    private fun requestService() {
        ...
        viewModel.launchUI {
            try {
                val bean = com.jwei.publicone.https.params.BindDeviceBean()
                ...
                val result = MyRetrofitClient.service.bindDevice(JsonUtils.getRequestJson(TAG, bean, com.jwei.publicone.https.params.BindDeviceBean::class.java))
