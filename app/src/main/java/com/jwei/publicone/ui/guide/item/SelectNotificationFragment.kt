...
import com.jwei.publicone.databinding.FragmentSelectNotificationBinding
...
import com.jwei.publicone.ui.device.setting.notify.NotifyOtherSetActivity
...
//                v.line.visibility = if (t.isShowLine) View.VISIBLE else View.GONE
    ...
    private fun requestPermissions() {
        com.jwei.publicone.utils.PermissionUtils.requestPermissions(
            ...
            com.jwei.publicone.utils.PermissionUtils.PERMISSIONS_MAIL_AND_PHONE_LIST
        ) {
            if (MyNotificationsService.checkNotificationIsEnable(requireActivity())
                && MyNotificationsService.checkNotificationPolicyAccessGranted(requireActivity())
            ) {
