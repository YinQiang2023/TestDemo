...
public class GpsCoordinateUtils {
    ...
    public static double[] calWGS84toGCJ02(double latitude, double longitude) {
        ...
        return numberFormat6(new double[]{retLat, retLon});
    }
    ...
    public static double[] calWGS84toBD09(double latitude, double longitude) {
        ...
        double retLat = latitude + dev.getLatitude();
        double retLon = longitude + dev.getLongitude();
        return numberFormat6(calGCJ02toBD09(retLat, retLon));
    }
    ...
    public static double[] calBD09toWGS84(double latitude, double longitude) {
        ...
        return numberFormat6(calGCJ02toWGS84(gcj[0], gcj[1]));
    }
    ...
    private static double[] numberFormat6(double[] l) {
        //NumberFormat nf = NumberFormat.getNumberInstance(); 德语环境下 为 ：23,12345 异常
        ...
        temp[0] = Double.parseDouble(nf.format(l[0]));
        temp[1] = Double.parseDouble(nf.format(l[1]));
        return temp;
    }
}