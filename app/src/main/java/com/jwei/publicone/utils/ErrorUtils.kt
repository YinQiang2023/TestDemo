...
import com.jwei.publicone.https.ErrorLogRetrofitClient
import com.jwei.publicone.https.HttpCommonAttributes
import com.jwei.publicone.https.params.ErrorLogBean
...
//                            })
    ...
    public fun sendEmailError(email: String, type: String) {
        scope.launch {
            val log =
                StringBuffer("time:${com.blankj.utilcode.util.TimeUtils.getNowString(com.jwei.publicone.utils.TimeUtils.getSafeDateFormat(TimeUtils.DATEFORMAT_COMM))} , Error email:" + email)
