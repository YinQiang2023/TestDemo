...
//    }
    ...
    fun setUserInformation() {
        if (ControlBleTools.getInstance().isConnect) {
            ...
            val userProfile = UserInfo()
            userProfile.age =
                DateUtils.getAgeFromBirthTime(TimeUtils.string2Date(mUserBean.birthDate, com.jwei.publicone.utils.TimeUtils.getSafeDateFormat(DateUtils.TIME_YYYY_MM_DD)))
