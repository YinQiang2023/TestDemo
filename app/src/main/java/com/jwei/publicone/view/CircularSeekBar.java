...
public class CircularSeekBar extends View {
    ...
    protected void initAttributes(TypedArray attrArray) {
        ...
        mMax = attrArray.getInt(R.styleable.CircularSeekBar_seekbar_max, DEFAULT_MAX);
        mProgress = attrArray.getInt(R.styleable.CircularSeekBar_circularSeekBar_progress, DEFAULT_PROGRESS);
