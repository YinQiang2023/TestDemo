...
import com.jwei.publicone.ui.refresh.CustomizeRefreshHeader
...
class BaseApplication : Application(), OnMapsSdkInitializedCallback {
    companion object {
        ...
        fun initDataReduction() {
            com.jwei.publicone.utils.AppUtils.tryBlock {
    ...
    override fun onCreate() {
        ...
        if (packageName == name) {
            ...
            //debug log
            LogUtils.getConfig().setLogSwitch(com.jwei.publicone.utils.AppUtils.isBetaApp()).setBorderSwitch(false)
    ...
    fun initControlBleTools(context: Context) {
        //设备日志 仅测试版本写日志
        val isWriteLog = com.jwei.publicone.utils.AppUtils.isBetaApp()
        ...
        if (ControlBleTools.getInstance().isInit) {
            com.jwei.publicone.utils.LogUtils.d("SDK", "initControlBleTools return : isInit == true")
            return
        }
    ...
    class NotificationServiceConnection : ServiceConnection {
        override fun onServiceConnected(name: ComponentName?, service: IBinder?) {
            com.jwei.publicone.utils.LogUtils.d("MyNotificationsService", "onServiceConnected:$name")
        }

        override fun onServiceDisconnected(name: ComponentName?) {
            com.jwei.publicone.utils.LogUtils.d("MyNotificationsService", "onServiceDisconnected:$name")
        }
    }
    //endregion
    ...
    private fun initBetaFireWareUpPath() {
        if (com.jwei.publicone.utils.AppUtils.isBetaApp()) {
    ...
    private fun initNetWorkListener() {
        ...
        NetworkUtils.registerNetworkStatusChangedListener(object : NetworkUtils.OnNetworkStatusChangedListener {
            override fun onDisconnected() {
                ...
                com.jwei.publicone.utils.LogUtils.e("NetWork", "网络断开连接", true)
            ...
            override fun onConnected(networkType: NetworkUtils.NetworkType?) {
                ...
                com.jwei.publicone.utils.LogUtils.e("NetWork", "网络连接上", true)
                //刷新设备语言列表
