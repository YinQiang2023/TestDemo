...
import com.jwei.publicone.https.params.QueryExerciseDetailsParam
import com.jwei.publicone.https.params.QueryExerciseListParam
import com.jwei.publicone.https.response.SportExerciseResponse
import com.jwei.publicone.ui.data.Global
import com.jwei.publicone.ui.sport.bean.SportDataBean
import com.jwei.publicone.ui.sport.livedata.SportLiveData
                            ...
                            serData.list!!.forEach { ser ->
                                ...
                                if (sqlBean != null) {
                                    ...
                                    ser.date = TimeUtils.millis2String(
                                        ser.sportTime * 1000,
                                        com.jwei.publicone.utils.TimeUtils.getSafeDateFormat(com.jwei.publicone.utils.TimeUtils.DATEFORMAT_COMM)
                                    )
