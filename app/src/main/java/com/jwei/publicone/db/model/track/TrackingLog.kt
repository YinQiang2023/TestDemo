package com.jwei.publicone.db.model.track
...
class TrackingLog {
    ...
    companion object TYPEINSTANCT {
         ...
         */
        @JvmStatic
        fun getNowString(): String = TimeUtils.getNowString(com.jwei.publicone.utils.TimeUtils.getSafeDateFormat("yyyy-MM-dd HH:mm:ss:SSS"))
    }
